...
public class Hearts {
    ...
    private static final BufferedImage heartAnimations = Atlas.getSpriteAtlas(Atlas.HEART_ANIMATIONS);
    /**
    ...
    public void displayHearts(Graphics2D graphics, Entity entity, int xOffset, int yOffset) {
        ...
        BufferedImage currentHeart = heartAnimations.getSubimage((int) Math.floor(animationCounter)*16, 0, 16, 16);
